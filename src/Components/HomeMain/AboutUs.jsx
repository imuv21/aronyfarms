                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
                    ...
                    <div className="overflow-hidden">
                        <motion.div
                            ...
                            transition={{ duration: 1, ease: "easeOut" }} className="space-y-6" style={{ pointerEvents: leftInView ? "auto" : "none" }}
                        >
                    ...
                    <div className="overflow-hidden">
                        <motion.div
                            ...
                            transition={{ duration: 1, ease: "easeOut" }} className="space-y-6" style={{ pointerEvents: rightInView ? "auto" : "none" }}
                        >
