...
const ChooseUs = () => {
  ...
  const [leftRefSec, leftInViewSec] = useInViewTrigger();
  const [rightRefSec, rightInViewSec] = useInViewTrigger();
            ...
            <div className="grid lg:grid-cols-2 gap-0 rounded-md overflow-hidden">
              ...
              <div className="overflow-hidden">
                <motion.div
                  ...
                  transition={{ duration: 1, ease: "easeOut" }} className="relative flex justify-center items-center"
              ...
              <div className="overflow-hidden">
                <motion.div
                  ...
                  transition={{ duration: 1, ease: "easeOut" }} className="bg-[#4BA625] p-6 sm:p-8 lg:p-10 flex flex-col justify-between h-full"
        ...
        <div className="mt-16">
          <div className="max-w-6xl mx-auto lg:max-w-7xl lg:ml-auto lg:pr-0">
            <div className="grid lg:grid-cols-2 gap-0 rounded-md overflow-hidden">
              ...
              <div className="overflow-hidden">
                <motion.div
                  ref={leftRefSec} initial={{ x: -120, opacity: 0 }}
                  animate={leftInViewSec ? { x: 0, opacity: 1 } : { x: -120, opacity: 0 }}
                  transition={{ duration: 1, ease: "easeOut" }} className="bg-[#4BA625] p-6 sm:p-8 lg:p-10 flex flex-col justify-between h-full"
                  style={{ pointerEvents: leftInViewSec ? "auto" : "none" }}
                >
                  {/* Top content - slightly pushed down */}
                  <div className="mt-6 sm:mt-10">
                    <p className="text-white text-base sm:text-lg md:text-xl leading-relaxed">
              ...
              <div className="overflow-hidden">
                <motion.div
                  ref={rightRefSec} initial={{ x: 120, opacity: 0 }}
                  animate={rightInViewSec ? { x: 0, opacity: 1 } : { x: 120, opacity: 0 }}
                  transition={{ duration: 1, ease: "easeOut" }} className="relative flex justify-center items-center"
                  style={{ pointerEvents: rightInViewSec ? "auto" : "none" }}
                >
                  <img
                    src={cofounder2}
                    alt="Co-Founder"
